...
VENDORS = {
    ...
    "hdinter": {
        # 원래 base_url이 hd-inter.co.kr이었는데, 사이트가 hicorporation.co.kr로
        # 이전(리브랜딩)하면서 도메인 레벨 리다이렉트는 되지만 경로/쿼리스트링이
        # 유지되지 않는다 - goods_list.php?cateCd=... 로 직접 접속하면 카테고리와
        # 무관하게 홈(main/index.php)으로 떨어져서, 크롤러가 어떤 카테고리를
        # 요청하든 항상 홈 화면의 추천상품 목록(~93개)만 긁고 있었다(실측 확인).
        # base_url을 새 도메인으로 직접 바꾸면 카테고리별로 정상적으로 다른
        # 상품이 나온다.
        "name": "현동몰", "base_url": "https://www.hicorporation.co.kr", "free_shipping_threshold": 200000,
        # 예전엔 대분류 코드(예: "020003")로만 순회했는데, 그 코드들은 상세
        # 목록이 아니라 카테고리 소개/추천상품만 보여주는 랜딩페이지였다(실측
        # 확인 - 어떤 대분류 코드를 넣어도 동일한 목록이 나옴). 실제 상품 목록은
        # 한 단계 더 들어간 소분류 코드에만 있어서, 사이트 내비게이션 메뉴에서
        # 직접 확인한 소분류 코드를 전부 나열한다.
        "catalog_category_code": [
            "020003001", "020003002", "020003003", "020003004", "020003005",
            "020003006", "020003007", "020003008", "020003009", "020003010", "020003012",
            "020006001", "020006002", "020006003", "020006004", "020006005", "020006006", "020006007",
            "020005001", "020005002", "020005003", "020005004",
            "021003001", "021003002", "021003003", "021003004", "021003005", "021003006", "021003007",
            "021004001", "021004002", "021004003",
            "022003001", "022003002",
            "022004001", "022004002", "022004003",
            "023001001", "023001002", "023001003", "023001004", "023001005", "023001007", "023001009",
            "023002001", "023002002",
            "025002",
            "028",
        ],
    ...
    "mud5": {
        ...
        # 자체가 하위 카테고리를 전부 합친 목록을 보여줘서(실측: 001002000이
        # 젤리/초콜릿/캔디 483개 전체 - 하위 소분류 낱개를 나열할 필요 없음)
        # 또요몰처럼 소분류를 다 나열하지 않고 대분류만 순회한다. 001007000은
        # 없음(사이트 메뉴에 그 번호가 아예 없음), 001006000(아이스크림)은
        # 현재 0개지만 나중에 채워질 수 있어 남겨둔다.
        "catalog_category_code": [
            "001001000",  # 특가상품
            "001002000",  # 젤리/초콜릿/캔디
            "001003000",  # 세계과자
